 ...
 */
UCLASS()
class UISHOWCASE_API UAsyncAction_PushSoftWidget : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()

public:
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject",
			HidePin="WorldContextObject", BlueprintInternalUseOnly = "true"),
	...
	static UAsyncAction_PushSoftWidget* PushSoftWidget(const UObject* WorldContextObject,
	                                                   ...
	                                                   UPARAM(meta = (Categories = "Frontend.WidgetStack")) FGameplayTag
	                                                   InWidgetStackTag,
